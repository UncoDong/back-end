...
def getPair():
    ...
    for key in x.keys():
        a=x[key]
        a=list(a)[0:random.randint(20,30)]
...
def evaluate(encoder, decoder, sentence, max_length=MAX_LENGTH):
    note = {0:'C4', 1:'C4#', 2:'D4', 3:'D4#', 4:'E4', 5:'F4', 6:'F4#', 7:'G4',
            8:'G4#', 9:'A4', 10:'A4#', 11:'B4', 12:'C5', 13:'C5#', 14:'D5', 15:'D5#',
            16:'E5', 17:'F5', 18:'F5#', 19:'G5', 20:'G5#', 21:'A5',22: 'A5#', 23:'B5',
           24: 'C6', 25:'C6#', 26:'D6', 27:'D6#', 28:'E6', 29:'F6', 30:'F6#', 31:'G6',
            32:'G6#',33: 'A6', 34:'A6#', 35:'B6', 36:'C7', 37:'C7#'}
    with torch.no_grad():
        ...
        for di in range(max_length):
            ...
            # print(topi.item())
            decoded_words.append(note[topi.item()])
...
trainIters(encoder1, attn_decoder1, 20)
